...
use StrictlyPHP\Tests\Dolphin\Fixtures\InsertRegularUserMiddleware;
use StrictlyPHP\Tests\Dolphin\Fixtures\TestRequiresRoleController;
...
class AppRoleTest extends TestCase
{
    ...
    public function setUp(): void
    {
        $this->app = App::build(
            controllers: [
                TestRequiresRoleController::class,
            ],
            middlewares: [
    ...
    public function testItRunsForRequireRoles(): void
    {
        $event = [
            "http" => [
                "path" => "/test",
    ...
    public function testItRunsForRequireRolesReturns403(): void
    {
        $event = [
            "http" => [
                "path" => "/test",
        ...
        $app = App::build(
            ...
            middlewares: [
                InsertRegularUserMiddleware::class,
            ]
        );
    ...
    public function testItRunsForRequireRolesReturns401(): void
    {
        $event = [
            "http" => [
                "path" => "/test",
